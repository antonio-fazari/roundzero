...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `FK_E52FFDEEA6005CA0` FOREIGN KEY (`roundId`) REFERENCES `rounds` (`id`),
  CONSTRAINT `FK_E52FFDEEA76ED395` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `rounds` (
  ...
  CONSTRAINT `FK_3A7FD55461220EA6` FOREIGN KEY (`userId`) REFERENCES `users` (`id`),
  CONSTRAINT `FK_3A7FD554FE54D947` FOREIGN KEY (`groupId`) REFERENCES `groups` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tokens` (
  ...
  CONSTRAINT `FK_AA5A118EA76ED395` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
